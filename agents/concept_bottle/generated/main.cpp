...
/** \mainpage RoboComp::concept_bottle
 *
 * \section intro_sec Introduction
 *
 * The concept_bottle component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/concept_bottle --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class concept_bottle : public Ice::Application
{
public:
	concept_bottle (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData concept_bottle::getInitializationDataIce(){
...
void concept_bottle::initialize()
{
...
int concept_bottle::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	concept_bottle app(configFile, prefix, startup_check_flag);
