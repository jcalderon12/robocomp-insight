...
/** \mainpage RoboComp::concept_robot
 *
 * \section intro_sec Introduction
 *
 * The concept_robot component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/concept_robot --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "concept_robot"
#define SERVER_FULL_NAME   "RoboComp concept_robot::concept_robot"
...
class concept_robot : public Ice::Application
{
public:
	concept_robot (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData concept_robot::getInitializationDataIce(){
...
int concept_robot::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	concept_robot app(configFile, prefix, startup_check_flag);
