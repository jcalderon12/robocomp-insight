...
/** \mainpage RoboComp::concept_person
 *
 * \section intro_sec Introduction
 *
 * The concept_person component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/concept_person --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "concept_person"
#define SERVER_FULL_NAME   "RoboComp concept_person::concept_person"
...
class concept_person : public Ice::Application
{
public:
	concept_person (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData concept_person::getInitializationDataIce(){
...
void concept_person::initialize()
{
...
int concept_person::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
	...
	try
	{
		...
		//Subscribe code
		subscribe<VisualElementsPubI>(communicator(),
		                    topicManager, configLoader.get<std::string>("Endpoints.VisualElementsPubTopic"),
						    configLoader.get<std::string>("Endpoints.VisualElementsPubPrefix"), "VisualElementsPub", worker,  0,
						    visualelementspub_topic, visualelementspub, PROGRAM_NAME);
...
int main(int argc, char* argv[])
{
	...
	concept_person app(configFile, prefix, startup_check_flag);
