...
/** \mainpage RoboComp::bullshit_publisher
 *
 * \section intro_sec Introduction
 *
 * The bullshit_publisher component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/bullshit_publisher --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "bullshit_publisher"
#define SERVER_FULL_NAME   "RoboComp bullshit_publisher::bullshit_publisher"



class bullshit_publisher : public Ice::Application
{
public:
	bullshit_publisher (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData bullshit_publisher::getInitializationDataIce(){
...
void bullshit_publisher::initialize()
{
...
int bullshit_publisher::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	bullshit_publisher app(configFile, prefix, startup_check_flag);
