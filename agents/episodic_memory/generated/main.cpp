...
/** \mainpage RoboComp::episodic_memory
 *
 * \section intro_sec Introduction
 *
 * The episodic_memory component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/episodic_memory --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "episodic_memory"
#define SERVER_FULL_NAME   "RoboComp episodic_memory::episodic_memory"



class episodic_memory : public Ice::Application
{
public:
	episodic_memory (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData episodic_memory::getInitializationDataIce(){
...
void episodic_memory::initialize()
{
...
int episodic_memory::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	episodic_memory app(configFile, prefix, startup_check_flag);
