...
## Dependencies
The following dependencies are required to build and run mission_controller. Ensure they are installed and properly configured on your system before proceeding:
```
<YOUR DEPENDENCIES>
```

## Configuration parameters
Like any other component, mission_controller requires a configuration file to start. In etc/config or etc/config.toml, you can find an example of the configuration file.
...
bin/mission_controller etc/yourConfig # Execute the component
```
-----
-----
# Developer Notes
This section explains how to work with the generated code of mission_controller, including what can be modified and how to use key features.
## Editable Files
