...
/** \mainpage RoboComp::mission_controller
 *
 * \section intro_sec Introduction
 *
 * The mission_controller component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/mission_controller --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "mission_controller"
#define SERVER_FULL_NAME   "RoboComp mission_controller::mission_controller"



class mission_controller : public Ice::Application
{
public:
	mission_controller (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData mission_controller::getInitializationDataIce(){
...
void mission_controller::initialize()
{
...
int mission_controller::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	mission_controller app(configFile, prefix, startup_check_flag);
